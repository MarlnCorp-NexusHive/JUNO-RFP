...
const purchaseRequests = [
  { id: 1, item: "Marketing Software License", category: "Software", quantity: 5, unitPrice: 1200, total: 6000, requestedBy: "Abdullah Al-Rashid", date: "2026-11-15", status: "Pending", priority: "High" },
  { id: 2, item: "Event Equipment Rental", category: "Equipment", quantity: 1, unitPrice: 3500, total: 3500, requestedBy: "Noura Al-Zahra", date: "2026-11-14", status: "Approved", priority: "Medium" },
  { id: 3, item: "Printing Services", category: "Services", quantity: 1000, unitPrice: 2.5, total: 2500, requestedBy: "Khalid Al-Sayed", date: "2026-11-13", status: "In Progress", priority: "Low" },
  { id: 4, item: "Advertising Materials", category: "Materials", quantity: 500, unitPrice: 15, total: 7500, requestedBy: "Fatima Al-Rashid", date: "2026-11-12", status: "Completed", priority: "High" },
];

const vendors = [
  { id: 1, name: "Tech Solutions Inc.", category: "Software", rating: 4.8, totalOrders: 45, totalSpent: 125000, lastOrder: "2026-11-10", status: "Active" },
  { id: 2, name: "Print Services Co.", category: "Printing", rating: 4.5, totalOrders: 32, totalSpent: 89000, lastOrder: "2026-11-08", status: "Active" },
  { id: 3, name: "Event Equipment Rentals", category: "Equipment", rating: 4.2, totalOrders: 18, totalSpent: 67000, lastOrder: "2026-11-05", status: "Active" },
  { id: 4, name: "Marketing Materials Ltd.", category: "Materials", rating: 4.7, totalOrders: 28, totalSpent: 95000, lastOrder: "2026-11-03", status: "Active" },
];

const purchaseOrders = [
  { id: 1, poNumber: "PO-2026-001", vendor: "Tech Solutions Inc.", items: 3, total: 15000, date: "2026-11-15", status: "Pending", expectedDelivery: "2026-11-25" },
  { id: 2, poNumber: "PO-2026-002", vendor: "Print Services Co.", items: 1, total: 2500, date: "2026-11-14", status: "Confirmed", expectedDelivery: "2026-11-20" },
  { id: 3, poNumber: "PO-2026-003", vendor: "Event Equipment Rentals", items: 2, total: 3500, date: "2026-11-13", status: "Delivered", expectedDelivery: "2026-11-18" },
];

export default function MarketingHeadProcurement() {
      ...
      <main className="flex-1 p-4 md:p-6 flex flex-col gap-8 overflow-x-auto">
        ...
        <header className={`flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 ${isRTLMode ? 'flex-row-reverse' : ''}`}>
          <div className={`flex-1 min-w-0 ${isRTLMode ? 'text-right' : 'text-left'}`}>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Procurement</h1>
            <p className="text-gray-600 dark:text-gray-400">Manage purchase requests, vendors, and procurement tracking</p>
          </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th className="text-left py-3 px-4 font-medium text-gray-700 dark:text-gray-300">Total</th>
                        <th className="text-left py-3 px-4 font-medium text-gray-700 dark:text-gray-300">Date</th>
                        <th className="text-left py-3 px-4 font-medium text-gray-700 dark:text-gray-300">Expected Delivery</th>
                        <th className="text-left py-3 px-4 font-medium text-gray-700 dark:text-gray-300">Status</th>
                        <th className="text-left py-3 px-4 font-medium text-gray-700 dark:text-gray-300">Actions</th>
                      </tr>
                    </thead>
                        ...
                        <tr key={order.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                          ...
                          <td className="py-3 px-4">
                            <span className={`px-2 py-1 rounded text-sm ${
                              ...
                              order.status === 'Confirmed' ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' :
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-white">$35,000</span>
                      </div>
                      <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-white">$20,000</span>
                      </div>
                      <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                      <div className="flex items-center gap-3">
                        <FiTrendingDown className="text-red-500 w-5 h-5" />
                        <span className="text-gray-900 dark:text-white">Last Month</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                      ...
                      <span className="text-lg font-bold text-gray-900 dark:text-white">$4,250</span>
                    </div>
                  </div>
                </div>
              </div>
