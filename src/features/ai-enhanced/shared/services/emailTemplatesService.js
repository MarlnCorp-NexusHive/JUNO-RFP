...
FORMAT AS JSON:
{
  ...
  getFallbackEmail(lead, emailType) {
    const templates = {
      'follow-up': {
        subject: `Follow-up: ${lead.interest} Offering at Our Firm`,
        greeting: `Dear ${lead.name},`,
        body: `Thank you for your interest in our ${lead.interest} program. We wanted to follow up and provide you with additional information that might be helpful in your decision-making process.\n\nOur firm offers excellent opportunities in ${lead.interest}, and we believe you would be a great fit for our program. We'd love to schedule a personal consultation to discuss your goals and answer any questions you might have.`,
      ...
      'program-introduction': {
        subject: `Discover Our ${lead.interest} Program`,
        greeting: `Dear ${lead.name},`,
        body: `We're excited to introduce you to our ${lead.interest} program, which has been designed to provide students with comprehensive knowledge and practical skills in this field.\n\nOur program offers:\n• Expert faculty with industry experience\n• State-of-the-art facilities\n• Career placement assistance\n• Flexible scheduling options\n\nWe believe this program aligns perfectly with your interests and career goals.`,
      ...
      'event-invitation': {
        ...
        greeting: `Dear ${lead.name},`,
        body: `We're delighted to invite you to our upcoming Agency Industry Day, where you can review our capabilities, meet the capture team, and learn more about our ${lead.interest} offering.\n\nThis is a great opportunity to:\n• Tour our facilities\n• Meet current clients\n• Speak with capture leads\n• Get your questions answered\n\nWe'd love to see you there!`,
      ...
      'application-reminder': {
        ...
        greeting: `Dear ${lead.name},`,
        body: `We wanted to remind you that the application deadline for our ${lead.interest} program is approaching soon. We've been impressed by your interest and would hate for you to miss this opportunity.\n\nTo ensure your application is complete, please make sure to submit all required documents. If you need any assistance or have questions, our recruitments team is here to help.`,
