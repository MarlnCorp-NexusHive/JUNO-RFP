...
import { FiDollarSign, FiTrendingUp, FiPackage, FiUsers, FiFileText } from "react-icons/fi";
      ...
      <main className="flex-1 p-4 md:p-6 flex flex-col gap-8 overflow-x-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Labor rates, cost volumes, subcontractors, and proposal pricing analytics.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            {["labor", "volumes", "trends"].map((tab) => (
              <button
                key={tab}
              ...
              >
                {tab === "labor" ? "Labor Rates" : tab === "volumes" ? "Cost Volumes" : "Trends"}
              </button>
            ))}
          </div>
        </div>
          ...
          <>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Labor Rates by Role</h2>
              </div>
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={laborRates} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="rate" fill="#6366f1" radius={[4, 4, 0, 0]} name="Blended ($/hr)" />
                  <Bar dataKey="loaded" fill="#22c55e" radius={[4, 4, 0, 0]} name="Loaded ($/hr)" />
                  <Bar dataKey="billable" fill="#f59e0b" radius={[4, 4, 0, 0]} name="Billable ($/hr)" />
                </BarChart>
              </ResponsiveContainer>
            </motion.section>
          </>
          ...
          <>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Cost Volumes by Proposal ($K)</h2>
              </div>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={costVolumes} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="labor" fill="#6366f1" radius={[4, 4, 0, 0]} name="Labor" />
                  <Bar dataKey="subcontractors" fill="#22c55e" radius={[4, 4, 0, 0]} name="Subcontractors" />
          ...
          <>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Win Price vs Target Cost ($M)</h2>
              </div>
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={pricingTrend} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="winPrice" stroke="#6366f1" strokeWidth={2} name="Win Price" />
                  <Line type="monotone" dataKey="targetCost" stroke="#22c55e" strokeWidth={2} name="Target Cost" />
                </LineChart>
              </ResponsiveContainer>
            </motion.section>
          </>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Pricing Summary</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <div className="text-sm text-gray-600 dark:text-gray-400">Active Proposals (Pricing)</div>
              <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">4</div>
            </div>
            <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <div className="text-sm text-gray-600 dark:text-gray-400">Avg. Win Price (YTD)</div>
              <div className="text-2xl font-bold text-green-600 dark:text-green-400">$2.4M</div>
            </div>
            <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
              <div className="text-sm text-gray-600 dark:text-gray-400">Target Cost Ratio</div>
              <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">82%</div>
            </div>
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              <div className="text-sm text-gray-600 dark:text-gray-400">Subcontractor Share</div>
