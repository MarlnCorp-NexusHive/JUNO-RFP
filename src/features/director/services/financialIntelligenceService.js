...
class FinancialIntelligenceService {
  ...
  async analyzeFinancials(corporateData, analysisType = "health", timePeriod = "yearly") {
    try {
      console.log("Starting financial intelligence analysis with data:", corporateData);
      
      const prompt = this.buildFinancialAnalysisPrompt(corporateData, analysisType, timePeriod);
      ...
      return this.processFinancialAnalysis(response, corporateData, analysisType, timePeriod);
    } catch (error) {
      console.error("Financial intelligence analysis error:", error);
      return this.getFallbackFinancialAnalysis(corporateData, analysisType, timePeriod);
    }
  }

  // Build AI prompt for financial intelligence
  buildFinancialAnalysisPrompt(data, analysisType, timePeriod) {
    const basePrompt = `As a corporate financial intelligence expert, analyze the following corporate financial data and provide comprehensive financial insights and recommendations.
