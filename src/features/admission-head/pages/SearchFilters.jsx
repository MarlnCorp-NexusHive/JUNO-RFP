...
const mockRole = 'recruitment_head';
...
const mockResults = [
  ...
  },
  {
    ...
    phone: '+1 (202) 555-678 9012',
    status: 'Verified',
    program: 'IT Team',
    tags: ['Remote', 'Senior Level'],
    assigned: 'Khalid Al-Sayed',
    lastFollowUp: '2026-10-05',
  ...
  },
  {
    ...
    phone: '+1 (202) 555-789 0123',
    status: 'Pending',
    program: 'Engineering Team',
    tags: ['Internal Transfer'],
    assigned: 'Aisha Al-Hassan',
    lastFollowUp: '2026-10-04',
  ...
  },
  {
    ...
    phone: '+1 (202) 555-890 1234',
    status: 'Verified',
    program: 'Sales Team',
    tags: ['Executive', 'Premium'],
    assigned: 'Fatima Al-Rashid',
    lastFollowUp: '2026-10-03',
